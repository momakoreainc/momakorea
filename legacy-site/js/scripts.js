( function($) {
  'use strict';
    ...
    if ($('.pagepiling').length > 0){
		...
		/* Page Piling Init */
      	...
      	$('.pagepiling').pagepiling({
		    ...
		    anchors: ['main', 'about', 'works', 'approach', 'contacts'],
    ...
    var options = {
      center: new kakao.maps.LatLng(35.863177,127.121052),
      level: 3
    };

    var map = new kakao.maps.Map(container, options);
    var markerPosition  = new kakao.maps.LatLng(35.863177,127.121052); 
